// Copied from client/src/hooks/useLongPressMenu.ts — see extensions/_shared's
// module comment (and useListNavigation.ts) on why this is a copy, not a
// shared runtime import: extension code can't reach client/src, and esbuild
// aliases these `react` imports to the host's single React instance.
